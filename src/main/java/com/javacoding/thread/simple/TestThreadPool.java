package com.javacoding.thread.simple;
...
public class TestThreadPool {
	...
	private class CalculationTaskTest implements Task, Runnable {
		...
		public void setEnd(boolean flag) {
			...
			// throw new
			// java.lang.UnsupportedOperationException("Method setEnd() not yet implemented.");
			isEnd = flag;
		}
		...
		public void startTask() throws Exception {
			/** @todo: Implement this Task method */
			// throw new
			// java.lang.UnsupportedOperationException("Method startTask() not yet implemented.");
		...
		public void endTask() throws Exception {
			/** @todo: Implement this Task method */
			// throw new
			// java.lang.UnsupportedOperationException("Method endTask() not yet implemented.");
			// free resource here
		}
		...
		public boolean isEnd() {
			/** @todo: Implement this Task method */
			// throw new
			// java.lang.UnsupportedOperationException("Method isEnd() not yet implemented.");
			return isEnd;
		}
	}
}
